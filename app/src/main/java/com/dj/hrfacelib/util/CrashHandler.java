...
//            mgr.set(AlarmManager.RTC, System.currentTimeMillis() + 30, restartIntent);
//
            // 退出程序
...
//            System.exit(0);
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            String fileName = "take_food_crash-" + time + "-" + timestamp + ".txt"; // 崩溃日志的文件
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                String path = Environment.getExternalStorageDirectory()
                        .getAbsolutePath()
                        + File.separator + "take_food_crash"; // 崩溃日志的存储路径
