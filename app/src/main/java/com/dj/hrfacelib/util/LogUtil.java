...
public class LogUtil {
    ...
    private static String MYLOG_PATH_SDCARD_DIR = "DJ-LOG";// 日志文件在sdcard中的路径
    private static int SDCARD_LOG_FILE_SAVE_DAYS = 3;// sd卡中日志文件的最多保存天�??
    private static String MYLOGFILEName = "anzerExplain_log.txt";// 本类输出的日志文件名�??
